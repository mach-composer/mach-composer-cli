...
func renderSiteComponent(ctx context.Context, cfg *config.MachConfig, n dependency.Node) (string, error) {
	site := n.(*dependency.SiteComponent).SiteConfig
	siteComponent := n.(*dependency.SiteComponent).SiteComponentConfig
